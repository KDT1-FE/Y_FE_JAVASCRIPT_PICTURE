...
function createProfileElement(data) {
  ...
  const profilePositionEl = createProfileInfoElement('Position', getPositionLabel(data.member.position));
...
function getPositionLabel(positionValue) {
  ...
  const selectedOption = [...positionSelect.options].find((option) => option.value === positionValue);
