...
**[직원 관리 시스템 바로가기](https://employee-system.vercel.app/#/)**
...
- [x] AWS S3 / Firebase 같은 서비스를 이용하여 사진을 관리할 수 있는 페이지를 구현하세요.
- [x] 프로필 페이지를 개발하세요
...
프로젝트를 하면서 발생했던 이슈나 느꼈던 점을 적기엔 너무 길어질 것 같아서

정리한 내용이 담겨있는 노션 첨부합니다!

[https://youthful-jump-c97.notion.site/0fe014827b4b440ca585bc3baa46fc78?pvs=4](https://www.notion.so/0fe014827b4b440ca585bc3baa46fc78?pvs=21)

( 한 번씩 읽어보시고 피드백 주시면 감사하겠습니다 .. )
